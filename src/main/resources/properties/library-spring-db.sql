CREATE USER IF NOT EXISTS 'library-spring'@'localhost' IDENTIFIED BY 'library-spring';
...
INSERT INTO `user_detail` (`first_name`, `last_name`, `email`)
VALUES ("Edard", "Stark", "edard.stark@winterfell.com"),
       ("Sam", "Tarly", "sam.tarly@night-watch.com"),
       ("Cersai", "Lanister", "cersai.lanister@kings-landing.com")
;

INSERT INTO `user` (`login`, `password`, `enable`, `user_detail_id`)
VALUES ("adusermin", "$2a$10$TDb0af7bDK9Gr4xAPoqZqunjFVLCM6togtL556J.M4BEJeUZd7psu", TRUE, 1),
...
INSERT INTO `user` (`login`, `password`, `enable`)
VALUES ("ysargin", "123456789", TRUE)
;
